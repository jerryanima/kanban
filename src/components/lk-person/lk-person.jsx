import css from './lk-person.module.css'
import { useState } from 'react';
import { Link } from 'react-router-dom';

const LkPerson = props => {
	const [isViible, setViible] = useState(true);
	...
	return (
		<div onClick={handleClick}>
			<div className={css.lk}>
				...
				{isViible && (<div className={css.arrow}><svg width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M1.415 0.209991L6 4.79499L10.585 0.209991L12 1.62499L6 7.62499L0 1.62499L1.415 0.209991Z" fill="white"/>
							</svg></div>)}
				{!isViible && (<div className={css.arrow}>
			...
			{!isViible && (<div>
				<ul className={css.submenu}>
					<li><Link to={'/'} className={css.link}>Profile</Link></li>
					<li><Link to={'/'} className={css.link}>Log Out</Link></li>
				</ul>
			</div>)}
		</div>
	)
